...
function MetricCard({ icon, label, value }) {
  return (
    <div className="min-h-[78px] rounded-[18px] border border-white/10 bg-[#0f1b2d] px-3 py-3 shadow-[0_16px_34px_rgba(0,0,0,0.24)] md:min-h-[92px] md:rounded-[22px] md:px-4 md:py-4">
      <div className="flex items-center gap-2.5 md:gap-3">
        <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-blue-600 text-white shadow-[0_10px_20px_rgba(37,99,235,0.22)] md:h-11 md:w-11">
          {icon}
        </span>
        <div className="min-w-0">
          <div className="text-[10px] font-black uppercase tracking-[0.08em] text-slate-400 md:text-xs">{label}</div>
          <div className="mt-0.5 line-clamp-2 text-sm font-black leading-tight text-white md:mt-1 md:text-base">{value}</div>
        </div>
      </div>
    </div>
  )
...
function MiniMapPreview({ onOpen, disabled }) {
  return (
    <div className="relative min-h-[190px] overflow-hidden rounded-[20px] border border-blue-100 bg-blue-50 shadow-inner md:min-h-[300px] md:rounded-[24px]">
      <div
      ...
      <div className="absolute left-1/2 top-[37%] -translate-x-1/2 text-blue-600 drop-shadow-[0_18px_26px_rgba(37,99,235,0.35)]">
        <IconPin className="h-16 w-16 md:h-24 md:w-24" />
      </div>
      ...
      <button
        ...
        onClick={onOpen}
        disabled={disabled}
        className="absolute bottom-3 right-3 inline-flex h-11 items-center gap-1.5 rounded-[16px] border border-blue-100 bg-white/95 px-3 text-sm font-black text-blue-700 shadow-[0_12px_26px_rgba(15,72,150,0.12)] transition active:scale-[0.98] disabled:opacity-55 md:bottom-4 md:right-4 md:h-14 md:gap-2 md:rounded-[20px] md:px-5 md:text-lg md:shadow-[0_16px_34px_rgba(15,72,150,0.14)]"
      >
        Abrir no mapa
...
function PedidoDetalhe() {
  ...
  return (
    <main className="min-h-[100dvh] bg-[#050b14] px-2 pb-[calc(env(safe-area-inset-bottom)+5.5rem)] pt-2 text-white md:px-5 md:py-5">
      <section className="mx-auto w-full max-w-[1540px] rounded-[22px] border border-white/10 bg-[#07111f] p-3 shadow-[0_24px_80px_rgba(0,0,0,0.32)] md:rounded-[34px] md:p-8">
        <header className="grid grid-cols-[48px_minmax(0,1fr)_auto] items-center gap-2 md:grid-cols-[auto_minmax(0,1fr)_auto] md:gap-3">
          <button
            type="button"
            onClick={voltarParaLista}
            className="grid h-12 w-12 place-items-center rounded-full border border-white/10 bg-white/[0.06] text-white shadow-[0_12px_28px_rgba(0,0,0,0.24)] transition active:scale-[0.98] md:h-[66px] md:w-[66px]"
            aria-label="Voltar"
          >
          ...
          <div className="min-w-0 text-center">
            <h1 className="truncate text-lg font-black tracking-tight md:text-[32px]">Detalhes do pedido</h1>
          ...
          <div className="justify-self-end">
            <span className="inline-flex h-11 max-w-[112px] items-center gap-1.5 rounded-full bg-blue-600 px-3 text-sm font-black text-white shadow-[0_12px_26px_rgba(37,99,235,0.20)] md:h-14 md:max-w-none md:gap-2 md:px-6 md:text-lg md:shadow-[0_16px_34px_rgba(37,99,235,0.25)]">
              <span className="grid h-6 w-6 shrink-0 place-items-center rounded-full bg-white/18 md:h-7 md:w-7">
        ...
        <div className="mt-4 rounded-[22px] border border-white/10 bg-[#0b1628] p-3 shadow-[0_18px_46px_rgba(0,0,0,0.22)] md:mt-7 md:rounded-[28px] md:p-6">
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_520px]">
            <div className="min-w-0 xl:border-r xl:border-white/10 xl:pr-5">
              <div className="flex flex-wrap items-center justify-between gap-2 md:gap-3">
                <span className="inline-flex max-w-full items-center gap-2 rounded-full border border-blue-400/20 bg-blue-500/10 px-3 py-2 text-sm font-black text-blue-100 md:gap-3 md:px-5 md:py-3 md:text-lg">
                  <span className="grid h-7 w-7 place-items-center rounded-full bg-blue-600 text-white md:h-9 md:w-9">
                    <IconBox className="h-4 w-4 md:h-5 md:w-5" />
                  </span>
                  <span className="truncate">{categoria}</span>
                </span>
                <span className="inline-flex items-center rounded-full border border-emerald-300/25 bg-emerald-500/10 px-3 py-2 text-sm font-black uppercase text-emerald-200 md:px-5 md:py-3 md:text-lg">
                  {statusLabel}
                </span>
              </div>

              <h2 className="mt-4 break-words text-[32px] font-black leading-[0.96] tracking-tight text-white min-[390px]:text-[36px] md:mt-6 md:text-[70px]">
                {tituloPedido}
              </h2>

              <div className="mt-5 md:mt-7">
                <h3 className="text-lg font-black text-blue-300 md:text-2xl">Descrição do pedido</h3>
                <p className="mt-2 whitespace-pre-wrap break-words text-base font-semibold leading-relaxed text-slate-200 md:mt-3 md:text-xl">
                  {descricaoPedido}
                </p>
              </div>

              <div className="mt-5 grid grid-cols-2 gap-2 md:mt-8 md:gap-4 2xl:grid-cols-4">
              ...
              <div className="mt-4 flex items-center gap-3 rounded-[18px] border border-white/10 bg-[#0f1b2d] px-3 py-3 shadow-[0_14px_30px_rgba(0,0,0,0.20)] md:mt-5 md:gap-4 md:rounded-[22px] md:px-5 md:py-4">
                <span className="grid h-12 w-12 shrink-0 place-items-center rounded-[16px] bg-blue-600 text-white shadow-[0_12px_24px_rgba(37,99,235,0.18)] md:h-16 md:w-16 md:rounded-[20px] md:shadow-[0_14px_30px_rgba(37,99,235,0.22)]">
                  <IconShield className="h-7 w-7 md:h-9 md:w-9" />
                </span>
                <div>
                  <div className="text-base font-black text-white md:text-xl">Pedido seguro</div>
                  <div className="mt-0.5 text-sm font-semibold leading-snug text-slate-400 md:mt-1 md:text-lg">
            ...
            <aside className="grid content-start gap-4 md:gap-5">
              <MiniMapPreview onOpen={() => setMapOpen(true)} disabled={!localOk} />

              <div className="rounded-[20px] border border-white/10 bg-[#0f1b2d] p-4 shadow-[0_14px_30px_rgba(0,0,0,0.20)] md:rounded-[24px] md:p-5">
                <div className="text-base font-black text-white md:text-lg">Enviado por</div>
                <div className="mt-4 flex items-center gap-3 md:mt-5 md:gap-4">
                  {criadorFoto ? (
                    ...
                    <img
                      src={criadorFoto}
                      alt=""
                      className="h-12 w-12 shrink-0 rounded-full object-cover ring-4 ring-blue-50 md:h-16 md:w-16"
                      loading="lazy"
                      referrerPolicy="no-referrer"
                    />
                  ) : (
                    <span className="grid h-12 w-12 shrink-0 place-items-center rounded-full bg-blue-500/10 text-base font-black text-blue-200 ring-4 ring-white/5 md:h-16 md:w-16 md:text-xl">
                      {getInitials(criadorNome)}
                    </span>
                  )}

                  <div className="min-w-0 flex-1">
                    <div className="truncate text-base font-black text-white md:text-xl">{criadorNome}</div>
                    <div className={`mt-0.5 flex items-center gap-1.5 text-sm font-semibold md:mt-1 md:gap-2 md:text-base ${criadorOnline ? 'text-emerald-600' : 'text-slate-500'}`}>
                  ...
                  <button
                    ...
                    className="grid h-12 w-12 shrink-0 place-items-center rounded-[16px] border border-white/10 bg-white/[0.06] text-blue-200 shadow-[0_12px_26px_rgba(0,0,0,0.18)] transition active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-45 md:h-16 md:w-16 md:rounded-[20px]"
                    aria-label="Abrir chat"
                  >
                    <IconChat className="h-6 w-6 md:h-8 md:w-8" />
                  </button>

                  <a
                    href={telefoneLink || undefined}
                    aria-disabled={!telefoneLink}
                    className={`grid h-12 w-12 shrink-0 place-items-center rounded-[16px] border border-white/10 bg-white/[0.06] shadow-[0_12px_26px_rgba(0,0,0,0.18)] transition active:scale-[0.98] md:h-16 md:w-16 md:rounded-[20px] ${telefoneLink ? 'text-blue-200' : 'pointer-events-none text-slate-600'}`}
                    aria-label="Ligar para o cliente"
                  >
                    <IconPhone className="h-6 w-6 md:h-8 md:w-8" />
                  </a>
                </div>
              </div>
            </aside>
        ...
        <div className="mt-4 grid grid-cols-2 gap-2 rounded-[20px] border border-white/10 bg-[#0f1b2d] p-2 shadow-[0_14px_36px_rgba(0,0,0,0.20)] md:mt-5 md:gap-0 md:rounded-[24px] md:p-4 xl:grid-cols-4 xl:divide-x xl:divide-white/10">
        ...
        <div className="sticky bottom-2 z-30 mt-4 grid grid-cols-[0.85fr_1.15fr] gap-2 rounded-[22px] border border-white/10 bg-[#07111f]/95 p-2 shadow-[0_18px_50px_rgba(0,0,0,0.32)] backdrop-blur lg:static lg:mt-6 lg:grid-cols-[340px_minmax(0,1fr)] lg:gap-4 lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none lg:backdrop-blur-0">
          <button
            type="button"
            onClick={voltarParaLista}
            className="flex min-h-[56px] items-center justify-center gap-2 rounded-[18px] border border-red-400/30 bg-red-500/10 px-3 text-sm font-black text-red-200 shadow-[0_12px_26px_rgba(0,0,0,0.18)] transition active:scale-[0.98] md:text-base lg:min-h-[86px] lg:gap-4 lg:rounded-[24px] lg:px-6 lg:text-2xl"
          >
            <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full bg-red-500/10 text-red-100 lg:h-16 lg:w-16">
              <IconX className="h-5 w-5 lg:h-8 lg:w-8" />
            </span>
            {podeAceitar || podeIniciarAtendimento ? 'Cancelar pedido' : 'Voltar'}
          </button>
          ...
          <button
            ...
            className={`flex min-h-[56px] flex-row items-center justify-center gap-2 rounded-[18px] px-3 text-white transition active:scale-[0.99] disabled:opacity-65 lg:min-h-[86px] lg:flex-col lg:gap-0 lg:rounded-[24px] lg:px-6 ${
              podeIniciarAtendimento
          ...
          >
            <span className={`grid h-9 w-9 shrink-0 place-items-center rounded-full bg-white lg:mb-2 lg:h-11 lg:w-11 ${podeIniciarAtendimento ? 'text-emerald-600' : 'text-blue-600'}`}>
              <IconCheck className="h-5 w-5 lg:h-7 lg:w-7" />
            </span>
            <span className="text-sm font-black leading-tight md:text-base lg:text-3xl lg:leading-none">{primaryLabel}</span>
